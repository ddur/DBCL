...
namespace DD.Collections.ICodeSet.CodeTest
{
	...
	public class CodeExtends
	{
		...
		[Test]
		public void HasCodeValue_NullableIntNull()
		{
			int? nullable = null;
			Assert.False(nullable.HasCodeValue());
		}
		...
		[Test, TestCaseSource("ValidChar"), TestCaseSource("ValidCode")]
		public void UnicodePlane_NullableIntValidCode(int value)
		{
			int? nullable = value;
		...
		[Test, TestCaseSource("InvalidCode")]
		public void UnicodePlane_NullableIntInvalidCode(int value)
		{
			int? nullable = value;
			Assert.Throws<ArgumentException> (
				delegate {
					nullable.UnicodePlane();
				}
			);
		}

		[Test]
		public void UnicodePlane_NullableIntNull() {
			int? nullable = null;
