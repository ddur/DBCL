    ...
    public sealed partial class BitSetArray :
        ...
        public sealed class Enumerator : IEnumerator<int>, IEnumerator, IDisposable {
            ...
            private static class Theory {
                ...
                [Pure]
                internal static bool Construct (Enumerator me, BitSetArray that) {
                ...
                [Pure]
                internal static bool MoveNext (Enumerator me, bool result) {
                    Success success = true;
                    if ( result ) {
                ...
                [Pure]
                internal static bool MoveNextOnThrow (Enumerator me) {
                    Success success = true;
                ...
                [Pure]
                internal static bool Current (Enumerator me, int retValue) {
                    Success success = true;
                ...
                [Pure]
                internal static bool CurrentOnThrow (Enumerator me) {
                    Success success = true;
        ...
        public sealed class EnumeratorComplement : IEnumerator<int>, IEnumerator, IDisposable {
            ...
            public EnumeratorComplement (BitSetArray that) {
                ...
                if ( this.doNext ) {
                    ...
                    if ( this.arrIndex == (this.arrayLen - 1) ) { // clear tail
                        this.bitItems &= ulong.MaxValue >> (longBits - (this.enumerated.range & 0x3F));
                    }
                }
                this.bitStart = 0;
                this.bitIndex = -1;
            ...
            private static class Theory {
                ...
                [Pure]
                internal static bool Construct (EnumeratorComplement me, BitSetArray that) {
                    Success success = true;
                ...
                [Pure]
                internal static bool MoveNext (EnumeratorComplement me, bool result) {
                    Success success = true;
                    if ( result ) {
                        success.Assert (!me.invalid);
                        success.Assert (!me.enumerated[me.bitStart + me.bitIndex]);
                ...
                [Pure]
                internal static bool MoveNextOnThrow (EnumeratorComplement me) {
                    Success success = true;
                ...
                [Pure]
                internal static bool Current (EnumeratorComplement me, int retValue) {
                    Success success = true;
                ...
                [Pure]
                internal static bool CurrentOnThrow (EnumeratorComplement me) {
                    Success success = true;
        ...
        public sealed class EnumeratorReverse : IEnumerator<int>, IEnumerator, IDisposable {
            ...
            private static class Theory {
                ...
                [Pure]
                internal static bool Construct (EnumeratorReverse me, BitSetArray that) {
                    Success success = true;
                ...
                [Pure]
                internal static bool MoveNext (EnumeratorReverse me, bool result) {
                    Success success = true;
                ...
                [Pure]
                internal static bool MoveNextOnThrow (EnumeratorReverse me) {
                    Success success = true;
                ...
                [Pure]
                internal static bool Current (EnumeratorReverse me, int retValue) {
                    Success success = true;
                ...
                [Pure]
                internal static bool CurrentOnThrow (EnumeratorReverse me) {
                    Success success = true;
        ...
        [NonSerialized]
        private const ulong table = 0x4332322132212110; // bit counter table
        //                            FEDCBA9876543210
        ...
        [Pure]
        public static bool ValidMember (int item) {
            return Theory.ValidMember (item);
        }

        [Pure]
        public static bool ValidLength (int item) {
            return Theory.ValidLength (item);
        }
        ...
        public static BitSetArray From (IEnumerable<int> items) {
            ...
            Contract.Requires<ArgumentOutOfRangeException> (Contract.ForAll<int> (items, item => ValidMember (item)));
            ...
            if ( items.IsEmpty () ) {
                ...
                Contract.Assume (Contract.ForAll<int> (items, item => ValidMember (item)));
        ...
        [Pure]
        public static BitSetArray From (int required, params int[] optional) {
            Contract.Requires<ArgumentOutOfRangeException> (
                ValidMember (required));
            Contract.Requires<ArgumentOutOfRangeException> (
                optional == null || optional.Length == 0 ||
                Contract.ForAll<int> (optional, item => ValidMember (item)));
            ...
            return BitSetArray.From (items); // Redirect to IEnumerable<int>

        }

        [Pure]
        public static BitSetArray From (BitSetArray that) {
            Contract.Requires<ArgumentNullException> (that.IsNot (null));
        ...
        [Pure]
        public static BitSetArray From (BitSetArray that, int length) {
            Contract.Requires<ArgumentNullException> (that.IsNot (null));
            Contract.Requires<ArgumentOutOfRangeException> (ValidLength (length));
        ...
        [Pure]
        public static BitSetArray Copy (BitSetArray that) {
            Contract.Requires<ArgumentNullException> (that.IsNot (null));
        ...
        [Pure]
        public static BitSetArray Mask (IEnumerable<bool> mask, int length) {
            Contract.Requires<ArgumentNullException> (mask != null);
            Contract.Requires<ArgumentOutOfRangeException> (ValidLength (length));
        ...
        [Pure]
        public static BitSetArray Mask (IEnumerable<byte> mask, int length) {
            Contract.Requires<ArgumentNullException> (mask != null);
            Contract.Requires<ArgumentOutOfRangeException> (ValidLength (length));
        ...
        [Pure]
        public static BitSetArray Mask (IEnumerable<short> mask, int length) {
            Contract.Requires<ArgumentNullException> (mask != null);
            Contract.Requires<ArgumentOutOfRangeException> (ValidLength (length));
        ...
        [Pure]
        public static BitSetArray Mask (IEnumerable<int> mask, int length) {
            Contract.Requires<ArgumentNullException> (mask != null);
            Contract.Requires<ArgumentOutOfRangeException> (ValidLength (length));
        ...
        [Pure]
        public static BitSetArray Mask (IEnumerable<long> mask, int length) {
            Contract.Requires<ArgumentNullException> (mask != null);
            Contract.Requires<ArgumentOutOfRangeException> (ValidLength (length));
        ...
        [Pure]
        public static int GetLongArrayLength (int length) {
            Contract.Requires<ArgumentOutOfRangeException> (ValidLength (length));
            Contract.Ensures (
                (length == 0 &&
        ...
        [Pure]
        public static int GetIntArrayLength (int length) {
            Contract.Requires<ArgumentOutOfRangeException> (ValidLength (length));
            Contract.Ensures (
                (length == 0 &&
                    Contract.Result<int> () == 0) ||
        ...
        [Pure]
        public static int GetShortArrayLength (int length) {
            Contract.Requires<ArgumentOutOfRangeException> (ValidLength (length));
            Contract.Ensures (
                (length == 0 &&
                    Contract.Result<int> () == 0) ||
        ...
        [Pure]
        public static int GetByteArrayLength (int length) {
            Contract.Requires<ArgumentOutOfRangeException> (ValidLength (length));
            Contract.Ensures (
                (length == 0 &&
                    Contract.Result<int> () == 0) ||
        ...
        [Pure]
        public static int CountOnBits (byte mask) {
        ...
        [Pure]
        public static int CountOnBits (short mask) {
        ...
        [Pure]
        public static int CountOnBits (long mask) {
        ...
        [Pure]
        [CLSCompliant (false)]
        public static int CountOnBits (ulong mask) {
            Contract.Ensures (Contract.Result<int> ().InRange (0, longBits));
            Contract.Ensures (Theory.CountOnBits (Contract.Result<int> (), mask));
        ...
        [Pure]
        public static int CountOnBits (BitArray mask) {
            Contract.Ensures (Theory.CountOnBits (Contract.Result<int> (), mask));
            ...
            if ( mask != null
                ...
                int[] array = new int[(mask.Length + 31) / 32];
                mask.CopyTo (array, 0);
        ...
        /// <returns></returns>
        [Pure]
        public static int CountOnBits (bool[] mask) {
            Contract.Ensures (Theory.CountOnBits (Contract.Result<int> (), mask));
        ...
        [Pure]
        public static int CountOnBits (int[] mask, int length) {
            Contract.Requires<ArgumentOutOfRangeException> (ValidLength (length));
        ...
        /// <returns></returns>
        [Pure]
        public static int CountOnBits (long[] mask, int length) {
            Contract.Requires<ArgumentOutOfRangeException> (ValidLength (length));
            Contract.Ensures (Theory.CountOnBits (Contract.Result<int> (), mask, length));
            ...
            if ( mask != null && mask.Length != 0 && length != 0 ) {
                ...
                // mask last bit-block up to range and count
                bitBlock = unchecked ((ulong)mask[arrLength - 1]) & (ulong.MaxValue >> (longBits - (length & 0x3F)));
                while ( bitBlock != 0 ) {
                    retCount += (int)((table >> (int)((bitBlock & 0xFul) << 2)) & 0xFul);
                    bitBlock >>= 4;
                }
        ...
        /// <returns></returns>
        [Pure]
        public static int CountOnBits (IEnumerable<bool> mask) {
        ...
        /// <returns></returns>
        [Pure]
        public static int CountOnBits (IEnumerable<byte> mask) {
            Contract.Ensures (Theory.CountOnBits (Contract.Result<int> (), mask));
        ...
        /// <returns></returns>
        [Pure]
        public static int CountOnBits (IEnumerable<short> mask) {
            Contract.Ensures (Theory.CountOnBits (Contract.Result<int> (), mask));
        ...
        /// <returns></returns>
        [Pure]
        public static int CountOnBits (IEnumerable<int> mask) {
            Contract.Ensures (Theory.CountOnBits (Contract.Result<int> (), mask));
        ...
        /// <returns></returns>
        [Pure]
        public static int CountOnBits (IEnumerable<long> mask) {
            Contract.Ensures (Theory.CountOnBits (Contract.Result<int> (), mask));
        ...
        public BitSetArray And (BitSetArray that) {
            ...
            if ( this.Is (that)
                ...
                for ( index = 0; index < opLength; index++ ) {
                    this.array[index] &= that.array[index];
        ...
        public BitSetArray Or (BitSetArray that) {
            ...
            if ( this.Is (that)
                ...
                // This operation only can optionally increase number of members 
                if ( this.count != temp_count ) {
                    this.count = temp_count;
                    this.AddVerson ();
                }
        ...
        public BitSetArray Not (BitSetArray that) {
            ...
            if ( this.Is (that) ) {
                ...
                for ( index = 0; index < opLength; index++ ) {
                    ...
                    // this.array[i] ^= (this.array[i] & that.array[i]);
                    this.array[index] &= ~(that.array[index]);
        ...
        public BitSetArray Not () {
            ...
            if ( this.range == 0 ) {
                ...
                this.ClearTail ();
                // This operation will absolutely change bit sequence
                this.AddVerson ();
            }
            return this;
        }
        ...
        public long[] To64BitMask () {
            ...
            //long[] retArray = new long[BitSetArray.GetLongArrayLength(this.range)];
            //Array.Copy(this.array, retArray, retArray.Length);
            //return retArray;
        }
        ...
        public int[] To32BitMask () {
            ...
            int[] intArray = new int[BitSetArray.GetIntArrayLength (this.range)];
        ...
        public short[] To16BitMask () {
            ...
            short[] shortArray = new short[BitSetArray.GetShortArrayLength (this.range)];
        ...
        public byte[] To8BitMask () {
            ...
            byte[] byteArray = new byte[BitSetArray.GetByteArrayLength (this.range)];
        ...
        public bool[] ToBoolMask () {
            ...
            bool[] boolArray = new bool[this.range];
        ...
        public BitArray ToBitArray () {
            ...
            BitArray bitArray = new BitArray (this.To32BitMask ());
        ...
        public int[] ToItems () {
            ...
            int[] itemsArray = new int[this.count];
            int counter = 0;
        ...
        public bool Get (int item) {
            ...
            return (array[item >> 6] & 1L << (item & 0x3F)) != 0;
        }
        ...
        public bool Set (int item, bool value = true) {
            ...
            if ( ((array[item >> 6] & 1L << (item & 0x3F)) != 0) == value ) {
                // no bit change
            }
            else { // flip bit value
                this.AddVerson ();
                array[item >> 6] ^= 1L << (item & 0x3F);
                if ( value ) {
        ...
        public IEnumerator<int> GetEnumerator () {
            return new BitSetArray.Enumerator (this);
        }
        ...
        public override bool Equals (Object that) {
            ...
            BitSetArray thatSet = that as BitSetArray;
            if ( thatSet.IsNot (null) ) {
                return this.SetEquals (thatSet);
            }
            IEnumerable<int> thatIEnum = that as IEnumerable<int>;
            if ( thatIEnum != null ) {
        ...
        public void ExceptWith (IEnumerable<int> that) {
            ...
            BitSetArray other = that as BitSetArray;
            if ( other.IsNot (null) ) {
                this.Not (other);
            }
            else if ( this.count == 0
                ...
                foreach ( var item in that ) {
                    ...
                    if ( this.InRange (item) ) {
                        this.Set (item, false); // -> this.AddVersion
                    }
                }
            }
        }
        ...
        public void SymmetricExceptWith (IEnumerable<int> that) {
            ...
            if ( other.IsNot (null) ) {
                ...
                other = BitSetArray.From (that.Where (item => ValidMember (item)));
                this.Xor (other);
            }
        }
        ...
        internal void ClearTail () {
            ...
            // clear tail bits
            // if this.array.Length==0 => this.range==0 => !((this.range&0x3F)!= 0) 
            if ( ((this.range & 0x3F) != 0) && ((this.array[rangeLength - 1] & (-1L << (this.range & 0x3F))) != 0) ) {
                // ATTN: -1L (0xFFFFFFFFFFFFFFFF) >> 63 !=  0x0000000000000001
                // ATTN: -1L (0xFFFFFFFFFFFFFFFF) >> 63 ==  0xFFFFFFFFFFFFFFFF (-1L)
                this.array[rangeLength - 1] &= unchecked ((long)(ulong.MaxValue >> (longBits - (this.range & 0x3F))));
                // checked by Ensures: Contract.Assert((this.array[rangeLength - 1] & (-1L << (this.range & 0x3F))) == 0);
            }
        ...
        public int Length {
            ...
            /// <summary>
            /// Setting .Length smaller will not automatically deallocate array space. Use TrimmExccess to dealocate
            /// </summary>
            set {
                ...
                if ( this.range != value ) {
                    ...
                    if ( value == 0 ) {
                        ...
                        if ( newRangeArrayLength > this.array.Length ) {
                            ...
                            long[] newArray = new long[newRangeArrayLength];
                            if ( this.count != 0 ) {
        ...
        public int? First {
            [Pure]
            get {
                Contract.Ensures (this.startVersion == this.version);
                Contract.Ensures (this.startMemoize == Contract.Result<int?> ());
                Contract.Ensures ((this.Count == 0 && Contract.Result<int?> () == null) ||
                                  (this.Count > 0 && Contract.Result<int?> () != null));
        ...
        public int? Last {
            [Pure]
            get {
                Contract.Ensures (this.finalVersion == this.version);
                Contract.Ensures (this.finalMemoize == Contract.Result<int?> ());
                Contract.Ensures ((this.Count == 0 && Contract.Result<int?> () == null) ||
                                  (this.Count > 0 && Contract.Result<int?> () != null));
