    ...
    public sealed partial class BitSetArray :
        ...
        public abstract class EnumeratorForwardAbstract : IEnumerator<int>, IEnumerator, IDisposable {
            ...
            private static class Theory {
                ...
                [Pure]
                public static bool Construct (EnumeratorForwardAbstract me, BitSetArray that) {
                ...
                [Pure]
                public static bool MoveNext (EnumeratorForwardAbstract me, bool result) {
                    Success success = true;
                    if (result) {
                ...
                [Pure]
                public static bool MoveNextOnThrow (EnumeratorForwardAbstract me) {
                    Success success = true;
                ...
                [Pure]
                public static bool Current (EnumeratorForwardAbstract me, int retValue) {
                    Success success = true;
                ...
                [Pure]
                public static bool CurrentOnThrow (EnumeratorForwardAbstract me) {
                    Success success = true;
        ...
        public abstract class EnumeratorComplementAbstract : IEnumerator<int>, IEnumerator, IDisposable {
            ...
            private static class Theory {
                ...
                [Pure]
                public static bool Construct (EnumeratorComplementAbstract me, BitSetArray that) {
                    Success success = true;
                ...
                [Pure]
                public static bool MoveNext (EnumeratorComplementAbstract me, bool result) {
                    Success success = true;
                    if (result) {
                        success.Assert (!me.invalid);
                        success.Assert (!me.enumerated[me.bitStart + me.bitIndex]);
                ...
                [Pure]
                public static bool MoveNextOnThrow (EnumeratorComplementAbstract me) {
                    Success success = true;
                ...
                [Pure]
                public static bool Current (EnumeratorComplementAbstract me, int retValue) {
                    Success success = true;
                ...
                [Pure]
                public static bool CurrentOnThrow (EnumeratorComplementAbstract me) {
                    Success success = true;
        ...
        public abstract class EnumeratorReverseAbstract : IEnumerator<int>, IEnumerator, IDisposable {
            ...
            private static class Theory {
                ...
                [Pure]
                public static bool Construct (EnumeratorReverseAbstract me, BitSetArray that) {
                    Success success = true;
                ...
                [Pure]
                public static bool MoveNext (EnumeratorReverseAbstract me, bool result) {
                    Success success = true;
                ...
                [Pure]
                public static bool MoveNextOnThrow (EnumeratorReverseAbstract me) {
                    Success success = true;
                ...
                [Pure]
                public static bool Current (EnumeratorReverseAbstract me, int retValue) {
                    Success success = true;
                ...
                [Pure]
                public static bool CurrentOnThrow (EnumeratorReverseAbstract me) {
                    Success success = true;
        ...
        [Pure]
        public static bool ValidMembers (IEnumerable<int> items) {
        ...
        public static BitSetArray From (IEnumerable<int> items) {
            Contract.Requires<ArgumentNullException> (!items.Is (null));
...
//                retValue.array[item >> log2of64] |= 1L << (item & mask0x3F);
//            }
//            retValue.count = CountOnBits (retValue.array);
            foreach (var item in items) {
                if ((retValue.array[item >> log2of64] & 1L << (item & mask0x3F)) != 0) {
                    // no bit change
                }
                else {
                    // set bit value
            ...
            Contract.Assume (retValue.count > 0);
            Contract.Assert (retValue.count <= retValue.range);
            retValue.setCacheFirst (minValue);
            retValue.setCacheLast (maxValue);
            return retValue;
        }
        ...
        [Pure]
        public static BitSetArray Empty () {
            Contract.Ensures (Contract.Result<BitSetArray> ().IsNot (null));
        ...
        /// <para>Set: Throws IndexOutOfRangeException if value == true && (item &lt; 0 || item &gt;= this.Length)</para>
        /// </summary>
        ...
        public int Add (IEnumerable<int> items) {
            ...
            Contract.EnsuresOnThrow<IndexOutOfRangeException> (Contract.OldValue<BitSetArray> (BitSetArray.Copy (this)) == this);
        ...
        /// </summary>
        /// <remarks>Use Add to add any valid item and exception on invalid item.</remarks>
        /// <param name="item"></param>
        /// <param name="value"></param>
        ...
        internal bool _SetMember (int item, bool value = true) {
            ...
            Contract.Ensures (Theory._SetMember (Contract.OldValue<BitSetArray> (BitSetArray.Copy (this)), item, value, this, Contract.Result<bool>()));
        ...
        internal int _SetMembers (IEnumerable<int> items, bool value = true) {
            ...
            Contract.Ensures (Theory._SetMembers (Contract.OldValue<BitSetArray> (BitSetArray.Copy (this)), items, value, this, Contract.Result<int>()));
            ...
            lock (SyncRoot) {
                ...
                foreach (var item in items) {
                    if (this.InRange (item)) {
                        ...
                        if (item > newFinal) { newFinal = item; }
                        if (((array[item >> log2of64] & 1L << (item & mask0x3F)) != 0) == value) {
                            // no change
                        }
                        else {
        ...
        /// <summary>
        /// Set all members where this.InRange (member) to value
        /// </summary>
        /// <param name="value"></param>
        /// <returns>number of members set/cleared</returns>
        public int SetAll (bool value) {
            Contract.Requires<ArgumentException> (value == value.Bool ());
                ...
                if (this.array.Length != 0) {
                    ...
                    if (value) {
                        if (this.count != this.range) {
                            itemsChanged = this.range - this.count;
                            this.AddVersion ();
                            this.count = this.range;
        ...
        /// <para>Throws IndexOutOfRangeException if index &lt; 0 || index &gt;= (array.Length - this.Count)</para>
        /// </summary>
        ...
        /// <para>For this operation is irrelevant wheter IEnumerable{int} is a set (contains no duplicates) or not.</para>
        /// <para>For this operation argument set IEnumerableOf{int} is not required to be within BitSetArray.domain.</para></remarks>
        /// <para>Since resulting set of SymmetricExceptWith operation cannot be outside BitSetArray.domain,</para>
        ...
        public bool IsSubsetOf (IEnumerable<int> that) {
            ...
            if (testSet.IsNot (null)) {
                ...
                // that.domain can be wider/larger than BitSetArray.domain => not subset
                try {
                    // On invalid "that" member exception is thrown
                    testSet = BitSetArray.From (that); // fast enough, uses _InitItems
                    return this.IsSubsetOf (testSet);
                } catch {
                    // "that" is not subset, contains members outside BitSetArray.domain
                    return false;
                }
            }
        }
